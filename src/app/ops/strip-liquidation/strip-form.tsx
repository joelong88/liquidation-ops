...
export function StripLiquidationForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { data, error } = await supabase.rpc('strip_sack', { p_sack_code: value, p_area: 'LIQUIDATION' })
    ...
    if (error) {
      ...
      if (result.ok) {
        ...
        setBanner({ ok: false, message: 'No open Liquidation-area sack with that code.' })
